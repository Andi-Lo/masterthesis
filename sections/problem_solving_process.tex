\begin{newpage}
  ...
  \label{sec:problemlösungsprozess}
    ...
    \label{sub:develop}
      ...
      \begin{figure}[htbp]
        \begin{center}
          \includegraphics[width=0.6\textwidth]{prozess/add_stations}
