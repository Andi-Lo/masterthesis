\subsection{Begriffe}
\label{sub:begriffe}
  Bevor im nächsten Kapitel "`\nameref{sec:develop}"' die Umsetzung des Projekts beschriebene wird, sollen zuerst in diesem Abschnitt die wichtigsten Begriffe definiert werden, um ein Einheitliches Verständnis zu garantieren.
